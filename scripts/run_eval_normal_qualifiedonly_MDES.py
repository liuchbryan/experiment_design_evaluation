...
for run in range(0, args.num_evals):
    ...
    design3_mde_size_evaluation = (
        EDMDESizeEvaluation(design3, n_init_samples=args.num_init_samples,
...
save_bootstrap_mean_evaluation_collection(
    design3_mde_size_evaluations, in_dir=args.output_dir, expt_design_name="normal_qualifiedonly", quantity_name="MDES")
