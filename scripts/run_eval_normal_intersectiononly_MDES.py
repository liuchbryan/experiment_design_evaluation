...
from pedeval.experiment_design import IntersectionOnlyNRED
...
script_description = \
    ...
    "of the intersection only experiment design (design 1) using bootstrap samples."
...
for run in range(0, args.num_evals):
    ...
    design1_mde_size_evaluation = (
        EDMDESizeEvaluation(design1, n_init_samples=args.num_init_samples,
...
save_bootstrap_mean_evaluation_collection(
    design1_mde_size_evaluations, in_dir=args.output_dir,
    expt_design_name="normal_intersectiononly", quantity_name="MDES")
