...
for run in range(0, args.num_evals):
    ...
    design2_mde_size_evaluation = (
        EDMDESizeEvaluation(design2, n_init_samples=args.num_init_samples,
...
save_bootstrap_mean_evaluation_collection(
    design2_mde_size_evaluations, in_dir=args.output_dir, expt_design_name="normal_allsample", quantity_name="MDES")
